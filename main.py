...
def submit_form(contact_form: ContactForm):
    ...
    try:
        ...
        whatsapp_message_body = f"Bonjour {contact_form.nom}, merci d'avoir soumis vos informations. Nous avons bien reçu vos données et allons vous contacter bientôt."
